...
def funcion_agregar(frame_principal):
    limpiar(frame_principal)
    label = tk.Label(frame_principal, text="Agregar", font=("Helvetica", 22, "bold"), bg="gray61", fg="blue4")
...
def funcion_editar(frame_principal):
    limpiar(frame_principal)
    label = tk.Label(frame_principal, text="Editar", font=("Helvetica", 22, "bold"), bg="gray61", fg="blue4")
    label.grid(column=0, row=0, columnspan=2, pady=10, sticky='NSEW')
    entries = fomulario(frame_principal)
...
def funcion_eliminar(frame_principal):
    limpiar(frame_principal)
    label = tk.Label(frame_principal, text="Eliminar", font=("Helvetica", 22, "bold"), bg="gray61", fg="blue4")
    label.grid(column=0, row=0, columnspan=2, pady=10, sticky='NSEW')
